...
pub struct MapArea {
    vpn_range: VPNRange,
    data_frames: BTreeMap<VirtPageNum, FrameTracker>,  // actual phys page except pagetable
    map_type: MapType,
...
impl MapArea {
    ...
    /// map one vpn with identical or framed ppn
    ...
    /// asssume that all frames were cleared before
...
// start global instance of kernel space
lazy_static!{
